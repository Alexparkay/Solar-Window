...
&#125;);</code
  ...
  <div class="mb-8">
    ...
    <p class="mb-4">
      Solar Window communicates with your application using the postMessage API. Here's how to
      listen for events:
    </p>
...
solarWindow.sendMessage('STATE_REQUEST', '');</code
  ...
  <div class="mb-8">
    ...
    <p class="mb-4">
      You can test the integration using our <a href="/embed-test" class="text-blue-600 underline"
        >embedding test page</a
      >.
    </p>
  </div>
  ...
  <div class="mb-8">
    ...
    <p>
      ...
      <a
        href="https://github.com/yourusername/solar-window/blob/main/EMBEDDING.md"
